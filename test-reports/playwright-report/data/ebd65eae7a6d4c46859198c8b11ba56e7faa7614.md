...
- Name: Phase 5.4: Immediate Reports E2E Tests >> Cross-Browser Compatibility >> should work correctly in firefox
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/immediateReports.spec.ts:301:11
...
Call log:
  - waiting for locator('[data-testid="product-website"]')
    ...
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/immediateReports.spec.ts:309:20
```
...
- main:
  ...
  - text: Project Name *
  - textbox "Project Name *": firefox Test 1752245504690
  - text: Description
  - textbox "Description"
  - text: Priority
  - combobox "Priority":
