...
- Name: Phase 5.4: Immediate Reports E2E Tests >> Mobile Responsiveness >> should be responsive at 1920x1080
...
Call log:
  ...
  - waiting for locator('[data-testid="create-project"]')
    ...
    at /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/immediateReports.spec.ts:354:36
```
