...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  17551 pixels (ratio 0.01 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/visual/components.visual.spec.ts-snapshots/reports-list-chromium-1920x1080-visual-regression-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-6a8a3-Component-responsive-layout-visual-regression/reports-list-chromium-1920x1080-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-6a8a3-Component-responsive-layout-visual-regression/reports-list-chromium-1920x1080-diff.png

Call log:
  - expect.toHaveScreenshot(reports-list-chromium-1920x1080.png) with timeout 10000ms
