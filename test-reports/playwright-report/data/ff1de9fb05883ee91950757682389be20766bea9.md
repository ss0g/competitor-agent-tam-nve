...
- Name: Mobile Browser Tests >> Mobile tap behavior on buttons
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/browser-specific/browser-quirks.spec.ts:206:7
...
Call log:
  - expect.toHaveScreenshot(mobile-tap-before-firefox-firefox-375x667.png) with timeout 10000ms
  ...
  - Timeout 10000ms exceeded.
    ...
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/browser-specific/browser-quirks.spec.ts:213:5
```
...
- main:
  ...
  - paragraph:
    ...
    - link "contact support":
      - /url: /support
    - text: .
- alert: Competitor Research Agent
