...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  3571 pixels (ratio 0.03 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/cross-browser/critical-features.spec.ts-snapshots/mobile-form-chromium-chromium-375x667-tablet-chrome-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/cross-browser-critical-fea-59ce4-bile-form-interaction-works-tablet-chrome/mobile-form-chromium-chromium-375x667-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/cross-browser-critical-fea-59ce4-bile-form-interaction-works-tablet-chrome/mobile-form-chromium-chromium-375x667-diff.png

Call log:
  - expect.toHaveScreenshot(mobile-form-chromium-chromium-375x667.png) with timeout 10000ms
...
- main:
  ...
  - text: Project Name *
  - textbox "Project Name *": Cross-browser Test 1752246054866
  - text: Description
  - textbox "Description"
  - text: Priority
  - combobox "Priority":
