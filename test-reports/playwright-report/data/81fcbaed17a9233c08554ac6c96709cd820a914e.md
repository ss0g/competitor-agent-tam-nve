...
Call log:
  - expect.toHaveScreenshot(grid-layout-webkit-webkit-834x1194.png) with timeout 10000ms
...
- main:
  ...
  - text: "⚠️ AWS Connection Failed Configuration: ✓ Credentials: ✗ Region: eu-west-1 Response: 1779ms Updated Just now"
  - button "Refresh"
  - group: Error Details
