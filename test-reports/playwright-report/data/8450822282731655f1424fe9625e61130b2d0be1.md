...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 89px by 25px, received 712px by 64px. 1374 pixels (ratio 0.04 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/visual/components.visual.spec.ts-snapshots/navigation-component-chromium-712x1138-tablet-chrome-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-74d9b-gation-Component-appearance-tablet-chrome/navigation-component-chromium-712x1138-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-74d9b-gation-Component-appearance-tablet-chrome/navigation-component-chromium-712x1138-diff.png

Call log:
  - expect.toHaveScreenshot(navigation-component-chromium-712x1138.png) with timeout 10000ms
