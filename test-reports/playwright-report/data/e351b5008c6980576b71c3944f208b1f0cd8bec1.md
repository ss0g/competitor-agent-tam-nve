...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 1920px by 1080px, received 1920px by 1163px. 41178 pixels (ratio 0.02 of all image pixels) are different.

Expected: /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/snapshots/visual/components.visual.spec.ts-snapshots/reports-list-chromium-1920x1080-visual-regression-darwin.png
Received: /Users/troy.edwards/code/competitor-agent-tam-nve/test-reports/artifacts/visual-components.visual-V-6a8a3-Component-responsive-layout-visual-regression/reports-list-chromium-1920x1080-actual.png
    Diff: /Users/troy.edwards/code/competitor-agent-tam-nve/test-reports/artifacts/visual-components.visual-V-6a8a3-Component-responsive-layout-visual-regression/reports-list-chromium-1920x1080-diff.png
...
- main:
  ...
  - list:
    - listitem:
      ...
      - text: File COMPLETED
      - paragraph: "Generated: 7/31/2025, 2:16:23 PM"
      - text: •
