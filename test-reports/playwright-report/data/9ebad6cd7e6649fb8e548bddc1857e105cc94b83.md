...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  3575 pixels (ratio 0.03 of all image pixels) are different.

Expected: /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/snapshots/cross-browser/critical-features.spec.ts-snapshots/mobile-form-chromium-chromium-375x667-tablet-chrome-darwin.png
Received: /Users/troy.edwards/code/competitor-agent-tam-nve/test-reports/artifacts/cross-browser-critical-fea-59ce4-bile-form-interaction-works-tablet-chrome/mobile-form-chromium-chromium-375x667-actual.png
    Diff: /Users/troy.edwards/code/competitor-agent-tam-nve/test-reports/artifacts/cross-browser-critical-fea-59ce4-bile-form-interaction-works-tablet-chrome/mobile-form-chromium-chromium-375x667-diff.png
...
Call log:
  ...
  - 3575 pixels (ratio 0.03 of all image pixels) are different.
    ...
    at /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/cross-browser/critical-features.spec.ts:338:5
```
...
- main:
  ...
  - text: Project Name *
  - textbox "Project Name *": Cross-browser Test 1753964083754
  - text: Description
  - textbox "Description"
  - text: Priority
  - combobox "Priority":
