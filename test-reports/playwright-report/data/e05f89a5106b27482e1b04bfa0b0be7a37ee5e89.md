...
- Name: Phase 5.4: Immediate Reports E2E Tests >> Cross-Browser Compatibility >> should work correctly in chromium
...
- main:
  ...
  - text: Project Name *
  - textbox "Project Name *": chromium Test 1752245364609
  - text: Description
  - textbox "Description"
  - text: Priority
  - combobox "Priority":
