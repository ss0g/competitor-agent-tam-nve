...
- Name: Phase 5.4: Immediate Reports E2E Tests >> Mobile Responsiveness >> should be responsive at 375x667
...
Call log:
  ...
  - waiting for locator('[data-testid="create-project"]')
    - waiting for" http://localhost:3000/projects/new" navigation to finish...
    - navigated to "http://localhost:3000/projects/new"
