...
- Name: Phase 5.4: Immediate Reports E2E Tests >> Error Scenarios and Recovery >> should provide retry options when generation fails
- Location: /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/immediateReports.spec.ts:265:9
...
Call log:
  - waiting for locator('[data-testid="product-website"]')
    ...
    at /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/immediateReports.spec.ts:271:18
```
...
- main:
  ...
  - text: Project Name *
  - textbox "Project Name *": Retry Test 1753963759696
  - text: Description
  - textbox "Description"
  - text: Priority
  - combobox "Priority":
