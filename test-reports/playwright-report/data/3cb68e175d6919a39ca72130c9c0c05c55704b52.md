...
Call log:
  - expect.toHaveScreenshot(grid-layout-chromium-chromium-712x1138.png) with timeout 10000ms
...
- main:
  ...
  - text: "⚠️ AWS Connection Failed Configuration: ✓ Credentials: ✗ Region: eu-west-1 Response: 780ms Updated Just now"
  - button "Refresh"
  - group: Error Details
