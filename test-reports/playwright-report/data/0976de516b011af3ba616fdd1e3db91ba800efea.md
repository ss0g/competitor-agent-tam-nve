...
```ts
  ...
  255 |       console.log(`✅ Analysis completed in ${analysisTime}ms`);
  256 |       
  257 |       // Validate analysis results
  258 |       await expect(page.locator(COMPREHENSIVE_E2E_CONFIG.selectors.analysis.result))
  259 |         .toBeVisible();
  260 |       
