...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  2621 pixels (ratio 0.02 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/cross-browser/critical-features.spec.ts-snapshots/mobile-form-firefox-firefox-375x667-firefox-desktop-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/cross-browser-critical-fea-59ce4-bile-form-interaction-works-firefox-desktop/mobile-form-firefox-firefox-375x667-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/cross-browser-critical-fea-59ce4-bile-form-interaction-works-firefox-desktop/mobile-form-firefox-firefox-375x667-diff.png

Call log:
  - expect.toHaveScreenshot(mobile-form-firefox-firefox-375x667.png) with timeout 10000ms
...
- main:
  ...
  - text: Project Name *
  - textbox "Project Name *": Cross-browser Test 1752245479850
  - text: Description
  - textbox "Description"
  - text: Priority
  - combobox "Priority":
