...
- Name: Browser-Specific Visual Tests >> CSS Grid layout rendering
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/visual/components.visual.spec.ts:107:7

# Error details

```
Error: Timed out 10000ms waiting for expect(locator).toHaveScreenshot(expected)

Locator: locator('.dashboard-grid')
  Timeout 10000ms exceeded.

Call log:
  - expect.toHaveScreenshot(grid-layout-chromium-chromium-393x727.png) with timeout 10000ms
    - generating new stable screenshot expectation
  - waiting for locator('.dashboard-grid')
  - Timeout 10000ms exceeded.

    at compareScreenshot (/Users/nikita.gorshkov/competitor-research-agent/e2e/helpers/visualRegressionHelper.ts:103:25)
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/visual/components.visual.spec.ts:111:5
```
...
- main:
  ...
  - heading "AWS Service" [level=2]
  - text: "⚠️ AWS Connection Failed Configuration: ✓ Credentials: ✗ Region: eu-west-1 Response: 1389ms Updated Just now"
  - button "Refresh"
  - group: Error Details
  - heading "Database" [level=3]
  - text: "💾 Database connection is healthy Status: Connected Type: PostgreSQL"
  - heading "Application" [level=3]
  - text: "🚀 Application services running normally Environment: Development Uptime: > 1h"
  - heading "Quick Actions" [level=2]
  - button "📁 Projects Manage your research projects":
    - text: 📁
    - heading "Projects" [level=3]
    - paragraph: Manage your research projects
  - button "📊 Reports View and generate reports":
    - text: 📊
    - heading "Reports" [level=3]
    - paragraph: View and generate reports
  - button "🏢 Competitors Manage competitor data":
    - text: 🏢
    - heading "Competitors" [level=3]
    - paragraph: Manage competitor data
  - button "💬 Chat Assistant Get help with analysis":
    - text: 💬
    - heading "Chat Assistant" [level=3]
    - paragraph: Get help with analysis
  - heading "Recent Activity" [level=2]
  - paragraph: AWS credentials are configured and working properly
  - paragraph: System check • Just now
  - paragraph: Dashboard enhanced with system status indicators
  - paragraph: System update • 2 minutes ago
  - paragraph: Error handling improvements deployed
  - paragraph: System update • 5 minutes ago
- alert
