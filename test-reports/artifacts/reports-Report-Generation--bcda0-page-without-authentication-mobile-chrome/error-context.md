...
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/reports.spec.ts:9:7
...
Call log:
  - waiting for locator('text=Reports')
    - locator resolved to 4 elements. Proceeding with the first one: <a href="/reports" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-900 hover:text-green-600">…</a>
  - attempting click action
    ...
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/reports.spec.ts:11:16
```
