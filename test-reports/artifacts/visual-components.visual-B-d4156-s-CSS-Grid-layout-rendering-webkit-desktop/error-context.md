...
Call log:
  - expect.toHaveScreenshot(grid-layout-webkit-webkit-1920x1080.png) with timeout 10000ms
...
- main:
  ...
  - text: "⚠️ AWS Connection Failed Configuration: ✓ Credentials: ✗ Region: eu-west-1 Response: 1867ms Updated Just now"
  - button "Refresh"
  - group: Error Details
