...
- Name: Browser-Specific Feature Tests >> Safari-specific features >> Safari textarea appearance
- Location: /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/browser-specific/browser-quirks.spec.ts:135:9
...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 848px by 60px, received 182px by 52px. 1933 pixels (ratio 0.04 of all image pixels) are different.

Expected: /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/safari-textarea-chromium-1920x1080-chromium-desktop-darwin.png
Received: /Users/troy.edwards/code/competitor-agent-tam-nve/test-reports/artifacts/browser-specific-browser-q-110c8--Safari-textarea-appearance-chromium-desktop/safari-textarea-chromium-1920x1080-actual.png
    Diff: /Users/troy.edwards/code/competitor-agent-tam-nve/test-reports/artifacts/browser-specific-browser-q-110c8--Safari-textarea-appearance-chromium-desktop/safari-textarea-chromium-1920x1080-diff.png

Call log:
  - expect.toHaveScreenshot(safari-textarea-chromium-1920x1080.png) with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('textarea')
    - locator resolved to <textarea rows="3" id="description" name="description" placeholder="Briefly describe the goals and scope of this competitive analysis" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
  ...
  - Expected an image 848px by 60px, received 182px by 52px. 1933 pixels (ratio 0.04 of all image pixels) are different.
    ...
    at /Users/troy.edwards/code/competitor-agent-tam-nve/e2e/browser-specific/browser-quirks.spec.ts:144:9
```
...
- main:
  ...
  - text: Description
  - textbox "Description": Testing Safari textarea appearance
  - text: Priority
  - combobox "Priority":
    - option "Low" [selected]
    - option "Medium"
