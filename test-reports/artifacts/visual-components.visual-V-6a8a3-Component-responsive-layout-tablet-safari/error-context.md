...
- Name: Visual Regression Tests - Key UI Components >> Reports List Component responsive layout
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/visual/components.visual.spec.ts:86:7
...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  17597 pixels (ratio 0.01 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/visual/components.visual.spec.ts-snapshots/reports-list-webkit-1920x1080-tablet-safari-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-6a8a3-Component-responsive-layout-tablet-safari/reports-list-webkit-1920x1080-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-6a8a3-Component-responsive-layout-tablet-safari/reports-list-webkit-1920x1080-diff.png

Call log:
  - expect.toHaveScreenshot(reports-list-webkit-1920x1080.png) with timeout 10000ms
    - verifying given screenshot expectation
  - waiting for locator('main')
    - locator resolved to <main class="min-h-screen">…</main>
  ...
  - 17570 pixels (ratio 0.01 of all image pixels) are different.
  ...
  - 17597 pixels (ratio 0.01 of all image pixels) are different.
    ...
    at multiViewportScreenshot (/Users/nikita.gorshkov/competitor-research-agent/e2e/helpers/visualRegressionHelper.ts:172:5)
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/visual/components.visual.spec.ts:92:5
```
...
- main:
  - heading "Generated Reports" [level=1]
  - paragraph: Download and review your competitor analysis reports
  - heading "No reports yet" [level=3]
  - paragraph: Use the Chat Agent to generate your first competitor analysis report.
  - link "Start Analysis":
    - /url: /chat
