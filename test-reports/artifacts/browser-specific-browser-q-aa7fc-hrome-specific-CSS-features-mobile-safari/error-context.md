...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 374px by 100px, received 390px by 100px. 2401 pixels (ratio 0.07 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/chrome-scrollbar-webkit-390x664-mobile-safari-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-mobile-safari/chrome-scrollbar-webkit-390x664-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-mobile-safari/chrome-scrollbar-webkit-390x664-diff.png

Call log:
  - expect.toHaveScreenshot(chrome-scrollbar-webkit-390x664.png) with timeout 10000ms
