...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 89px by 24px, received 1920px by 64px. 1686 pixels (ratio 0.02 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/visual/components.visual.spec.ts-snapshots/navigation-component-firefox-1920x1080-firefox-desktop-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-74d9b-gation-Component-appearance-firefox-desktop/navigation-component-firefox-1920x1080-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-74d9b-gation-Component-appearance-firefox-desktop/navigation-component-firefox-1920x1080-diff.png

Call log:
  - expect.toHaveScreenshot(navigation-component-firefox-1920x1080.png) with timeout 10000ms
