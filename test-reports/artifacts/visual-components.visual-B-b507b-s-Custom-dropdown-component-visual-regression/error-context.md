...
- Name: Browser-Specific Visual Tests >> Custom dropdown component
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/visual/components.visual.spec.ts:133:7
...
Locator: locator('.custom-dropdown')
  Timeout 10000ms exceeded.

Call log:
  - expect.toHaveScreenshot(dropdown-chromium-chromium-1920x1080.png) with timeout 10000ms
    - generating new stable screenshot expectation
  - waiting for locator('.custom-dropdown')
  - Timeout 10000ms exceeded.

    at compareScreenshot (/Users/nikita.gorshkov/competitor-research-agent/e2e/helpers/visualRegressionHelper.ts:103:25)
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/visual/components.visual.spec.ts:144:5
```
