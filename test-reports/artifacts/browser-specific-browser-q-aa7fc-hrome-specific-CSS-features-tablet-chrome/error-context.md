...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 696px by 100px, received 712px by 100px. 

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/chrome-scrollbar-chromium-712x1138-tablet-chrome-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-tablet-chrome/chrome-scrollbar-chromium-712x1138-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-tablet-chrome/chrome-scrollbar-chromium-712x1138-diff.png

Call log:
  - expect.toHaveScreenshot(chrome-scrollbar-chromium-712x1138.png) with timeout 10000ms
