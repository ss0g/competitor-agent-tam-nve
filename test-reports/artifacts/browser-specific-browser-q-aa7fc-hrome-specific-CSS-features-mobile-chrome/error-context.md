...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 377px by 100px, received 393px by 100px. 2221 pixels (ratio 0.06 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/chrome-scrollbar-chromium-393x727-mobile-chrome-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-mobile-chrome/chrome-scrollbar-chromium-393x727-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-mobile-chrome/chrome-scrollbar-chromium-393x727-diff.png
