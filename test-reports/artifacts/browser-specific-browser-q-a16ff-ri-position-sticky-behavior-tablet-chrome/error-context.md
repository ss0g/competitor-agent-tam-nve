...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 696px by 2038px, received 712px by 3246px. 190756 pixels (ratio 0.09 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/safari-sticky-before-chromium-712x1138-tablet-chrome-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-a16ff-ri-position-sticky-behavior-tablet-chrome/safari-sticky-before-chromium-712x1138-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-a16ff-ri-position-sticky-behavior-tablet-chrome/safari-sticky-before-chromium-712x1138-diff.png

Call log:
  - expect.toHaveScreenshot(safari-sticky-before-chromium-712x1138.png) with timeout 10000ms
