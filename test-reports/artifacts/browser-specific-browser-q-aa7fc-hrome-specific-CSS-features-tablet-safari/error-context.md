...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 818px by 100px, received 834px by 100px. 1672 pixels (ratio 0.03 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/chrome-scrollbar-webkit-834x1194-tablet-safari-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-tablet-safari/chrome-scrollbar-webkit-834x1194-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-tablet-safari/chrome-scrollbar-webkit-834x1194-diff.png

Call log:
  - expect.toHaveScreenshot(chrome-scrollbar-webkit-834x1194.png) with timeout 10000ms
