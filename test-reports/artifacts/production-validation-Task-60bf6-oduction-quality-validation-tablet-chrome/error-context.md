...
Call log:
  - waiting for locator('text=Create New Project')
    4 × waiting for" http://localhost:3000/projects" navigation to finish...
      - navigated to "http://localhost:3000/projects"

    at /Users/nikita.gorshkov/competitor-research-agent/e2e/production-validation.spec.ts:126:16
```
