...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 89px by 25px, received 393px by 64px. 717 pixels (ratio 0.03 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/visual/components.visual.spec.ts-snapshots/navigation-component-chromium-393x727-mobile-chrome-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-74d9b-gation-Component-appearance-mobile-chrome/navigation-component-chromium-393x727-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/visual-components.visual-V-74d9b-gation-Component-appearance-mobile-chrome/navigation-component-chromium-393x727-diff.png

Call log:
  - expect.toHaveScreenshot(navigation-component-chromium-393x727.png) with timeout 10000ms
