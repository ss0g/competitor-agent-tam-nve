...
- Location: /Users/nikita.gorshkov/competitor-research-agent/e2e/browser-specific/browser-quirks.spec.ts:72:9
...
Error: expect(locator).toHaveScreenshot(expected)
  ...
  Expected an image 1904px by 100px, received 1920px by 100px. 1513 pixels (ratio 0.01 of all image pixels) are different.

Expected: /Users/nikita.gorshkov/competitor-research-agent/e2e/snapshots/browser-specific/browser-quirks.spec.ts-snapshots/chrome-scrollbar-firefox-1920x1080-firefox-desktop-darwin.png
Received: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-firefox-desktop/chrome-scrollbar-firefox-1920x1080-actual.png
    Diff: /Users/nikita.gorshkov/competitor-research-agent/test-reports/artifacts/browser-specific-browser-q-aa7fc-hrome-specific-CSS-features-firefox-desktop/chrome-scrollbar-firefox-1920x1080-diff.png

Call log:
  - expect.toHaveScreenshot(chrome-scrollbar-firefox-1920x1080.png) with timeout 10000ms
  ...
  - Expected an image 1904px by 100px, received 1920px by 100px. 1513 pixels (ratio 0.01 of all image pixels) are different.
    ...
    at /Users/nikita.gorshkov/competitor-research-agent/e2e/browser-specific/browser-quirks.spec.ts:102:7
```
