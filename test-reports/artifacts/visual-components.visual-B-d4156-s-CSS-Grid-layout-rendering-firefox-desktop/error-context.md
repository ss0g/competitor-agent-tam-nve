...
Call log:
  - expect.toHaveScreenshot(grid-layout-firefox-firefox-1920x1080.png) with timeout 10000ms
...
- main:
  ...
  - text: "⚠️ AWS Connection Failed Configuration: ✓ Credentials: ✗ Region: eu-west-1 Response: 1366ms Updated Just now"
  - button "Refresh"
  - group: Error Details
